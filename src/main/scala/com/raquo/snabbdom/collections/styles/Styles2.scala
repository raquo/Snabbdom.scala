...
/**
  ...
  */
trait Styles2[N <: Node[N, D], D <: NodeData[N, D]] extends StyleMisc[N, D] { self: Builders[N, D] =>
  ...
  /**
    ...
    * MDN
    */
  lazy val animationDirection = style[String]("animationDirection", "animation-direction")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationDuration = style[String]("animationDuration", "animation-duration")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationName = style[String]("animationName", "animation-name")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationFillMode = style[String]("animationFillMode", "animation-fill-mode")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationIterationCount = style[Int]("animationIterationCount", "animation-iteration-count")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationTimingFunction = style[String]("animationTimingFunction", "animation-timing-function")
  ...
  /**
    ...
    * MDN
    */
  lazy val animationPlayState = style[String]("animationPlayState", "animation-play-state")
  /**
    ...
    * MDN
    */
  lazy val animation = style[String]("animation", "animation")
  ...
  /**
    ...
    * MDN
    */
  object backfaceVisibility extends Style[String, N, D]("backfaceVisibility", "backface-visibility") {
    /**
  ...
  /**
    ...
    * MDN
    */
  object columns extends Style[String, N, D]("columns", "columns") {
    def :=(number: Int, width: String): StyleSetter[String, N, D] = this := s"$number $width"
  }
  ...
  /**
    ...
    * MDN
    */
  object columnFill extends Style[String, N, D]("columnFill", "column-fill") {
    /**
  ...
  /**
    ...
    * MDN
    */
  lazy val columnRule = style[String]("columnRule", "column-rule")
  ...
  /**
    ...
    * MDN
    */
  object columnSpan extends Style[Int | String, N, D]("columnSpan", "column-span") {
    /**
  ...
  /**
    ...
    * MDN
    */
  lazy val columnRuleColor = style[String]("columnRuleColor", "column-rule-color")
  ...
  /**
    ...
    * MDN
    */
  object columnRuleWidth extends Style[String, N, D]("columnRuleWidth", "column-rule-width") {
  ...
  /**
    ...
    * MDN
    */
  lazy val content = style[String]("content", "content")
  ...
  /**
    ...
    * MDN
    */
  lazy val counterIncrement = style[String]("counterIncrement", "counter-increment")
  ...
  /**
    ...
    * MDN
    */
  lazy val counterReset = style[String]("counterReset", "counter-reset")
  ...
  /**
    ...
    * MDN
    */
  lazy val orphans = style[Int | String]("orphans", "orphans")
  ...
  /**
    ...
    * MDN
    */
  lazy val widows = style[Int | String]("widows", "widows")
  ...
  /**
    ...
    * MDN
    */
  lazy val perspectiveOrigin = style[String]("perspectiveOrigin", "perspective-origin")
  ...
  /**
    ...
    * MDN
    */
  lazy val transform = style[String]("transform", "transform")
  ...
  /**
    ...
    * MDN
    */
  lazy val transformOrigin = style[String]("transformOrigin", "transform-origin")
  ...
  /**
    ...
    * MDN
    */
  object transformStyle extends Style[String, N, D]("transformStyle", "transform-style") {
    /**
  ...
  /**
    ...
    * MDN
    */
  object unicodeBidi extends Style[String, N, D]("unicodeBidi", "unicode-bidi") {
    /**
  ...
  /**
    ...
    * MDN
    */
  object wordBreak extends Style[String, N, D]("wordBreak", "word-break") {
    /**
