...
trait InputAttrs[N <: Node[N, D], D <: NodeData[N, D]] { self: Builders[N, D] =>
  ...
  /**
    ...
    * MDN
    */
  lazy val action: Attr[String, N, D] = attr("action")
  ...
  /**
    ...
    * MDN
    */
  lazy val autoComplete: Attr[String, N, D] = attr("autocomplete")
  ...
  /**
    ...
    * MDN
    */
  lazy val autoFocus: Attr[Boolean, N, D] = attr("autofocus")
  ...
  /**
    ...
    * MDN
    */
  lazy val checked: Attr[Boolean, N, D] = attr("checked")

  /**
    * The `enctype` attribute provides the encoding type of the form when it is
    * submitted (for forms with a method of "POST").
    */
  lazy val encType: Attr[String, N, D] = attr("enctype")

  /**
    * The form attribute specifies one or more forms an `<input>` element belongs to.
    */
  lazy val formAttr: Attr[String, N, D] = attr("form") // TODO: Conflicts with "form" element
  ...
  /**
    ...
    * submit or image.
    */
  lazy val formAction: Attr[String, N, D] = attr("formaction")
  ...
  /**
    ...
    */
  lazy val formEncType: Attr[String, N, D] = attr("formenctype")
  ...
  /**
    ...
    * or "image".
    */
  lazy val formMethod: Attr[String, N, D] = attr("formmethod")
  ...
  /**
    ...
    * of `type` "submit".
    */
  lazy val formNoValidate: Attr[String, N, D] = attr("formnovalidate")
  ...
  /**
    ...
    */
  lazy val max: Attr[String, N, D] = attr("max")

  /**
    * The min attribute specifies the minimum value for an <input> element of type
    * number, range, date, datetime, datetime-local, month, time, or week.
    */
  lazy val min: Attr[String, N, D] = attr("min")
  ...
  /**
    ...
    * option.
    */
  lazy val multiple: Attr[Boolean, N, D] = attr("multiple")
  ...
  /**
    ...
    */
  lazy val maxLength: Attr[Int, N, D] = attr("maxlength")
  ...
  /**
    ...
    * MDN
    */
  lazy val method: Attr[String, N, D] = attr("method")
  ...
  /**
    ...
    * MDN
    */
  lazy val name: Attr[String, N, D] = attr("name")
  ...
  /**
    ...
    */
  lazy val pattern: Attr[String, N, D] = attr("pattern")
  ...
  /**
    ...
    * MDN
    */
  lazy val placeholder: Attr[String, N, D] = attr("placeholder")
  ...
  /**
    ...
    * MDN
    */
  lazy val readOnly: Attr[Boolean, N, D] = attr("readonly")
  ...
  /**
    ...
    * MDN
    */
  lazy val required: Attr[Boolean, N, D] = attr("required")
  ...
  /**
    ...
    * MDN
    */
  lazy val size: Attr[Int, N, D] = attr("size")
  ...
  /**
    ...
    */
  lazy val step: Attr[String, N, D] = attr("step")
  ...
  /**
    ...
    */
  lazy val target: Attr[String, N, D] = attr("target")
  ...
  /**
    ...
    * MDN
    */
  lazy val `type`: Attr[String, N, D] = attr("type")

  /**
    * Shorthand for the `type` attribute
    */
  lazy val tpe: Attr[String, N, D] = `type`

  /**
    * Shorthand for the `type` attribute
    */
  lazy val typ: Attr[String, N, D] = `type`
  ...
  /**
    ...
    * MDN
    */
  lazy val value: Attr[String, N, D] = attr("value")

  /**
    * The `width` attribute specifies the width of an `input` element of
    * `type` "image".
    */
  lazy val widthAttr: Attr[Int, N, D] = attr("width") // TODO: Conflicts with "width" in Styles
}
